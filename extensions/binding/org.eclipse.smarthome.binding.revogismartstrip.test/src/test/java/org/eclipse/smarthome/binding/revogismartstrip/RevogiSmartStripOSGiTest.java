...
/**
 * Test cases for {@link RevogiSmartStripHandler}.
 *
 * @author Andreas Bräu - Initial contribution
 */
public class RevogiSmartStripOSGiTest extends JavaOSGiTest {

    private static final ThingTypeUID BRIDGE_THING_TYPE_UID = new ThingTypeUID("revogismartstrip", "bridge");
    ...
    @Test
    public void creationOfRevogiSmartStripHandler() {
